...
public class BookMarkActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView("Bookmark", false);
		_vParent.setBackgroundColor(Color.TRANSPARENT);
		_vParent.setGravity(Gravity.BOTTOM);
	...
	protected void initBody() {
		final EditText etBookmarkName = EditText(_vParent, "write bookmark name");
		final EditText etBookmarkUrl = EditText(_vParent, "write url & uri");
		Button(_vParent, "Add bookmark icon home").setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				...
				else Toast.makeText(_appContext, "please write shortcun name!!", Toast.LENGTH_SHORT).show();
			}
		});
		
		final EditText etPackage = EditText(_vParent, "write app package name");
		Button(_vParent, "Add app icon home").setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				...
				else Toast.makeText(_appContext, "please write package name!!", Toast.LENGTH_SHORT).show();
			}
		});
