...
import com.breakout.sample.ui.viewpager.MultipleViewPagerViewModel;
import com.breakout.sample.ui.viewpager.OnRequestListener;
import com.breakout.sample.ui.viewpager.PageViewStatus;
import com.breakout.sample.ui.viewpager.PagerTab;
...
public class PagerFragment extends BaseFragment<PagerFragment.OnActionListener> implements View.OnTouchListener, View.OnClickListener {
    ...
    private VerticalViewPager _viewPager;
    ...
    protected void initViewPager(View rootView) {
        _viewPager = rootView.findViewById(R.id.viewPager1);
    ...
    protected ViewPager.OnPageChangeListener _onPageChangeCallback;
    ...
    protected void initAdapter(final ArrayList<NaverImageDto.Item> list) {
        ...
        _viewPager.removeOnPageChangeListener(_onPageChangeCallback);

        _onPageChangeCallback = new ViewPager.SimpleOnPageChangeListener() {
            int lastSize = 0;
        ...
        _adapter = new PagerAdapter(getActivity().getSupportFragmentManager(), list, _pageViewStatus);
        _viewPager.setAdapter(_adapter);
        _viewPager.addOnPageChangeListener(_onPageChangeCallback);
    }
