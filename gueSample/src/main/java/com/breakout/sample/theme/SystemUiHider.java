package com.breakout.sample.theme;
 ...
 * techniques described in <a href="http://developer.android.com/training/backward-compatible-ui/index.html">Creating Backward-Compatible UIs</a> 
 * to ensure that devices running any
...
public abstract class SystemUiHider {
	...
	/**
	 * The current visibility callback, dummy listener로 초기화
	 */
...
//		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) return new SystemUiHiderHoneycomb(activity, anchorView, flags);
		if (Build.VERSION.SDK_INT >= 11) return new SystemUiHiderHoneycomb(activity, anchorView, flags);
		else return new SystemUiHiderBase(activity, anchorView, flags);
	}
	...
	public void setOnVisibilityChangeListener(OnVisibilityChangeListener listener) {
		if (listener != null) mOnVisibilityChangeListener = listener;
	}
