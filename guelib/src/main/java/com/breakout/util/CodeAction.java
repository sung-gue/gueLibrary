...
//	private static final String AES256_SEED = "sample_01_aes_256_seed";
	 ...
	 * @since 2011.10.15
	 */
	public final static String CreateHmacSHA1 (String value, String HmacSHA1_KEY) throws Exception {
		nullCheck(value);
	 ...
	 * @since 2011.10.15
	 */
	public final static String EncodeMD5(String value) throws Exception {
		nullCheck(value);
	 ...
	 * @since 2011.10.15
	 */
	public final static String DecryptAES_QR(String value, String QR_AES256_KEY) throws Exception {
		nullCheck(value);
	 ...
	 * @since 2011.10.15
	 */
	final static byte[] genKey(String seed) throws Exception {
	 ...
	 * @since 2011.10.15
	 */
	public final static String EncryptAES(String value, String AES256_SEED) throws Exception {
		nullCheck(value);
...
*/
	 ...
	 * @since 2011.10.15
	 */
	public final static String DecryptAES(String value, String AES256_SEED) throws Exception {
		nullCheck(value);
		nullCheck(AES256_SEED);
...
*/
	 ...
	 * @since 2011.10.15
	 */
	public final static byte[] toByte(String value) throws Exception {
	 ...
	 * @since 2011.10.15
	 */
	public final static String toHex(byte value[]) throws Exception {
	 ...
	 * @since 2011.10.15
	 */
	private final static boolean nullCheck(String value) throws Exception {
	 ...
	 * @since 2011.10.15
	 */
	public final static String EncryptDES(String str, String keyValue) throws Exception {
		String result = "";
	 ...
	 * @since 2011.10.15
	 */
	public final static String DecryptDES(String str, String keyValue) throws Exception {
		String result = "";
		if (str != null && str.length() != 0) {
			String instance = (keyValue.length() == 24) ? "DESede/ECB/PKCS5Padding" : "DES/ECB/PKCS5Padding";
			Cipher cipher = Cipher.getInstance(instance);
			...
			result = new String(outputBytes2, "UTF8");
		}
		return result;
	}
	 ...
	 * @since 2011.10.15
	 */
	private final static Key getKey(String keyValue) throws Exception {
	 ...
	 * @since 2011.10.15
	 */
	private final static Key getKey1(String keyValue) throws Exception {
	 ...
	 * @since 2011.10.15
	 */
	private final static Key getKey2(String keyValue) throws Exception {
	 ...
	 * </ol>
	 */
	private final static byte[] EncodeBase64(byte[] binaryData) {
		byte[] buf = null;
		try {
	 ...
	 * </ol>
	 */
	private final static byte[] DecodeBase64(byte[] base64Data) {
		byte[] buf = null;
		try {
			Class<?> Base64 = Class.forName("org.apache.commons.codec.binary.Base64");
			Class<?>[] parameterTypes = new Class[] { byte[].class };
