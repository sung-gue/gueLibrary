...
public final class ImageAlter {
    ...
    /* ------------------------------------------------------------
        DESC: filter
     */
    public static Bitmap FilterSaturation(Bitmap bitmapSrc, float saturation, boolean recycle) throws Exception, OutOfMemoryError {
    ...
    public static Bitmap FilterSaturation(Bitmap bitmapSrc, float saturation) throws Exception, OutOfMemoryError {
        return FilterSaturation(bitmapSrc, saturation, true);
    }

    public static Bitmap FilterGray(Bitmap bitmapSrc, boolean recycle) throws Exception, OutOfMemoryError {
        Bitmap output = Bitmap.createBitmap(bitmapSrc.getWidth(), bitmapSrc.getHeight(), bitmapSrc.getConfig());
    ...
    public static Bitmap FilterGray(Bitmap bitmapSrc) throws Exception, OutOfMemoryError {
    ...
    public static Bitmap FilterMilky(Bitmap bitmapSrc, boolean recycle) throws Exception, OutOfMemoryError {
        Bitmap output = Bitmap.createBitmap(bitmapSrc.getWidth(), bitmapSrc.getHeight(), bitmapSrc.getConfig());
    ...
    public static Bitmap FilterMilky(Bitmap bitmapSrc) throws Exception, OutOfMemoryError {
        return FilterMilky(bitmapSrc, true);
    }

    public static Bitmap FilterSharpen(Bitmap bitmapSrc, boolean recycle) throws Exception, OutOfMemoryError {
        Bitmap output = Bitmap.createBitmap(bitmapSrc.getWidth(), bitmapSrc.getHeight(), bitmapSrc.getConfig());
    ...
    public static Bitmap FilterSharpen(Bitmap bitmapSrc) throws Exception, OutOfMemoryError {
...
//                { -2, weight, -2 },
    ...
    public static Bitmap FilterInvert(Bitmap bitmapSrc, boolean recycle) throws Exception, OutOfMemoryError {
        Bitmap output = Bitmap.createBitmap(bitmapSrc.getWidth(), bitmapSrc.getHeight(), bitmapSrc.getConfig());
    ...
    public static Bitmap FilterInvert(Bitmap bitmapSrc) throws Exception, OutOfMemoryError {
        return FilterInvert(bitmapSrc, true);
    }
    
    /*public static Bitmap FilterInvert1(Bitmap bitmapSrc, boolean recycle) throws Exception, OutOfMemoryError {
        int height = bitmapSrc.getHeight();
        int width = bitmapSrc.getWidth();
        Bitmap output = Bitmap.createBitmap(width, height, bitmapSrc.getConfig());
     ...
     * 모두 0일경우 회색<br/>
     */
    public static Bitmap FilterSepiaTone(Bitmap bitmapSrc, int depth, double red, double green, double blue, boolean recycle) throws Exception, OutOfMemoryError {
        int width = bitmapSrc.getWidth();
        int height = bitmapSrc.getHeight();
        Bitmap output = Bitmap.createBitmap(width, height, bitmapSrc.getConfig());
    ...
    public static Bitmap FilterSepiaTone(Bitmap bitmapSrc, int depth, double red, double green, double blue) throws Exception, OutOfMemoryError {
    ...
    public static Bitmap FilterReflection(Bitmap bitmapSrc) throws Exception, OutOfMemoryError {
...
//        Bitmap output = Bitmap.createBitmap(width, (height + height/2), Config.ARGB_8888);
    ...
    public static Bitmap FilterEmboss(Bitmap bitmapSrc) throws Exception, OutOfMemoryError {
...
//        convMatrix.Offset = 95;
    ...
    public static Bitmap FilterEngrave(Bitmap bitmapSrc) throws Exception, OutOfMemoryError {
...
//        final int COLOR_MIN = 0x00;
    ...
    /*public static Bitmap FilterTint(Bitmap bitmapSrc, int degree, boolean recycle) throws Exception, OutOfMemoryError {
        int width = bitmapSrc.getWidth();
        int height = bitmapSrc.getHeight();
        Bitmap output = Bitmap.createBitmap(width, height, bitmapSrc.getConfig());
    ...
    public static Bitmap circleImage(Bitmap bitmapSrc, int width, int height) throws OutOfMemoryError, Exception {
        if (width == 0) {
            width = bitmapSrc.getWidth();
            height = bitmapSrc.getHeight();
        } else {
    ...
    public static Bitmap roundCorner(Bitmap bitmapSrc, int roundPixel) throws OutOfMemoryError, Exception {
        return roundCorner(bitmapSrc, roundPixel, 0, 0);
    }

    public static Bitmap roundCorner(Drawable drawable, int roundPixel, int width, int height) throws OutOfMemoryError, Exception {
    ...
    public static Bitmap roundCorner(Drawable drawable, int roundPixel) throws OutOfMemoryError, Exception {
